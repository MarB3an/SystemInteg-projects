...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleCustomAccessDenied(AccessDeniedCustomException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleSpringAccessDenied(AccessDeniedException ex) {
        ...
        body.put("status", HttpStatus.FORBIDDEN.value());
        body.put("error", "Forbidden");
        body.put("message", "You do not have permission to access or modify this resource.");
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(body);
    }
